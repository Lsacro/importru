                ...
                <div className="px-4 md:px-10 py-4 max-w-7xl mx-auto flex items-center justify-between">
                    ...
                    <div className="hidden lg:flex items-center gap-8">
                        <nav className="flex gap-6 items-center">
                            ...
                            <Link className="text-sm font-medium text-text-main hover:text-primary transition-colors dark:text-gray-200 text-primary dark:text-primary" to="/enterprise/solutions">Solutions</Link>
